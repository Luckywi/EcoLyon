    ...
    private var detailSections: some View {
        VStack(spacing: 20) {
            ...
            detailCard(
                ...
                content: "Particules en suspension de diamètre inférieur à 10 μm (microns). Elles incluent les PM2.5 ainsi que des particules plus grosses."
            )
            
            // Les pics
            detailCard(
                title: "Les pics",
                content: "Les concentrations élevées de PM10 s'observent principalement en hiver lors d'épisodes de pollution, pendant les périodes anticycloniques ou lors d'événements sahéliens (poussières du Sahara)."
            )
            
            // Les effets sur la santé
            detailCard(
                title: "Les effets sur la santé",
                content: "Les PM10 se déposent principalement dans les voies respiratoires supérieures (nez, gorge, bronches). Elles peuvent provoquer une irritation et aggraver l'asthme et les troubles respiratoires, particulièrement chez les personnes sensibles."
            )
            ...
            detailCard(
                ...
                content: """
                • Remise en suspension de poussières (circulation, vent)
                • Trafic routier (échappements, freinage, usure des routes)
                • Activités de construction et chantiers
                • Industrie (cimenteries, carrières)
                • Chauffage résidentiel
                • Phénomènes naturels (érosion, pollens, sables sahariens)
                """
            )
        }
    }
